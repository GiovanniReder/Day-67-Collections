...
public class Main {
    public static void main(String[] args) {
        ...
        if (usersList.contains(aldo)) {
            // .contains() internamente utilizza il metodo .equals() degli oggetti in questione, ovviamente posso anche
            // sovrascriverlo per avere
        ...
        usersList.addAll(Arrays.asList(usersArray)); // <-- non posso passare direttamente un array al metodo
        // perché si aspetta una COLLECTION
        // quindi potrò passargli Liste, Set o Code ma non array. La soluzione è convertire l'array in una
        // Collection ad es in una Lista
        System.out.println("La lista ha " + usersList.size() + " elementi");
        System.out.println(usersList);
