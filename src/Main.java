...
/*		for (String lettera : listaStringhe) {
        ...
        // ************************************************************ SET ************************************************************
        Set<User> usersSet = new HashSet<>(); // Gli HashSet non consentono elementi duplicati e inoltre non mantengono l'ordine
        // di inserzione degli elementi
        // Set<User> usersSet = new LinkedHashSet<>(); // I LinkedHashSet come sopra non consento duplicati però
        // essi mantengono l'ordine di inserzione degli elementi
        // (occupano però più memoria degli HashSet)

        usersSet.add(aldo);
        usersSet.add(giovanni);
        usersSet.add(giacomo);
        // usersSet.add(aldo); <-- Fare una roba del genere non è vietato (nel senso che non mi verrà lanciata un'eccezione)
        // però IntelliJ mi segnala
        // la cosa con un warning perché per aggiungere due volte uno stesso elemento in un Set, esso dovrà prima
        // controllare tutti gli altri (potenzialmente
        ...
        // La chiave serve per accedere agli elementi in lettura, scrittura,rimozione...
